(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["views-app-calendar-app-calendar-module"],{
...
var validateEvents$1 = function (events) {
    var /** @type {?} */ warn = function () {
        ...
        return console.warn.apply(console, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](['angular-calendar'], args));
    };
...
var CalendarAngularDateFormatter = /** @class */ (function () {
    ...
    CalendarAngularDateFormatter.prototype.monthViewColumnHeader = function (_a) {
        ...
        return new _angular_common__WEBPACK_IMPORTED_MODULE_3__["DatePipe"](locale).transform(date, 'EEEE', locale);
    };
    /**
    ...
    CalendarAngularDateFormatter.prototype.monthViewDayNumber = function (_a) {
        var date = _a.date, locale = _a.locale;
        return new _angular_common__WEBPACK_IMPORTED_MODULE_3__["DatePipe"](locale).transform(date, 'd', locale);
    };
    /**
    ...
    CalendarAngularDateFormatter.prototype.monthViewTitle = function (_a) {
        var date = _a.date, locale = _a.locale;
        return new _angular_common__WEBPACK_IMPORTED_MODULE_3__["DatePipe"](locale).transform(date, 'MMMM y', locale);
    };
    /**
    ...
    CalendarAngularDateFormatter.prototype.weekViewColumnSubHeader = function (_a) {
        var date = _a.date, locale = _a.locale;
        return new _angular_common__WEBPACK_IMPORTED_MODULE_3__["DatePipe"](locale).transform(date, 'MMM d', locale);
    };
    /**
     * The week view title
     * @param {?} __0
    ...
    CalendarAngularDateFormatter.prototype.weekViewTitle = function (_a) {
        var date = _a.date, locale = _a.locale;
        var /** @type {?} */ year = new _angular_common__WEBPACK_IMPORTED_MODULE_3__["DatePipe"](locale).transform(date, 'y', locale);
    ...
    CalendarAngularDateFormatter.prototype.dayViewHour = function (_a) {
        var date = _a.date, locale = _a.locale;
        return new _angular_common__WEBPACK_IMPORTED_MODULE_3__["DatePipe"](locale).transform(date, 'h a', locale);
    };
    /**
     * The day view title
     * @param {?} __0
    ...
    CalendarAngularDateFormatter.prototype.dayViewTitle = function (_a) {
        var date = _a.date, locale = _a.locale;
        return new _angular_common__WEBPACK_IMPORTED_MODULE_3__["DatePipe"](locale).transform(date, 'EEEE, MMMM d, y', locale);
    };
...
var CalendarDateFormatter = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](CalendarDateFormatter, _super);
...
/*!**********************************************!*\
  !*** ./src/app/shared/models/event.model.ts ***!
  \**********************************************/
/*! exports provided: EgretCalendarEvent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EgretCalendarEvent", function() { return EgretCalendarEvent; });
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/index.js");
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(date_fns__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _shared_models_event_model__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../shared/models/event.model */ "./src/app/shared/models/event.model.ts");
/* harmony import */ var _app_calendar_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./app-calendar.service */ "./src/app/views/app-calendar/app-calendar.service.ts");
/* harmony import */ var _calendar_form_dialog_calendar_form_dialog_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./calendar-form-dialog/calendar-form-dialog.component */ "./src/app/views/app-calendar/calendar-form-dialog/calendar-form-dialog.component.ts");
/* harmony import */ var _shared_services_app_confirm_app_confirm_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../shared/services/app-confirm/app-confirm.service */ "./src/app/shared/services/app-confirm/app-confirm.service.ts");
...
var AppCalendarComponent = /** @class */ (function () {
    function AppCalendarComponent(dialog, calendarService, confirmService) {
        var _this = this;
        this.dialog = dialog;
    ...
    AppCalendarComponent.prototype.initEvents = function (events) {
        var _this = this;
        return events.map(function (event) {
            event.actions = _this.actions;
            return new _shared_models_event_model__WEBPACK_IMPORTED_MODULE_5__["EgretCalendarEvent"](event);
        });
    };
    AppCalendarComponent.prototype.loadEvents = function () {
        var _this = this;
    ...
    AppCalendarComponent.prototype.removeEvent = function (event) {
        var _this = this;
        this.confirmService
            .confirm({
            title: 'Delete Event?'
    ...
    AppCalendarComponent.prototype.addEvent = function () {
        var _this = this;
        this.dialogRef = this.dialog.open(_calendar_form_dialog_calendar_form_dialog_component__WEBPACK_IMPORTED_MODULE_7__["CalendarFormDialogComponent"], {
    ...
    AppCalendarComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"],
            ...
            _shared_services_app_confirm_app_confirm_service__WEBPACK_IMPORTED_MODULE_8__["AppConfirmService"]])
...
/*!***********************************************************!*\
  !*** ./src/app/views/app-calendar/app-calendar.module.ts ***!
  \***********************************************************/
/*! exports provided: AppCalendarModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var angular_calendar__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! angular-calendar */ "./node_modules/angular-calendar/esm5/angular-calendar.js");
...
/* harmony import */ var _app_calendar_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./app-calendar.component */ "./src/app/views/app-calendar/app-calendar.component.ts");
/* harmony import */ var _app_calendar_routing__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./app-calendar.routing */ "./src/app/views/app-calendar/app-calendar.routing.ts");
/* harmony import */ var _calendar_form_dialog_calendar_form_dialog_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./calendar-form-dialog/calendar-form-dialog.component */ "./src/app/views/app-calendar/calendar-form-dialog/calendar-form-dialog.component.ts");
/* harmony import */ var _app_calendar_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./app-calendar.service */ "./src/app/views/app-calendar/app-calendar.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppCalendarModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(_app_calendar_routing__WEBPACK_IMPORTED_MODULE_10__["CalendarRoutes"])
            ],
            providers: [_app_calendar_service__WEBPACK_IMPORTED_MODULE_12__["AppCalendarService"]],
            entryComponents: [_calendar_form_dialog_calendar_form_dialog_component__WEBPACK_IMPORTED_MODULE_11__["CalendarFormDialogComponent"]],
            declarations: [
                _app_calendar_component__WEBPACK_IMPORTED_MODULE_9__["AppCalendarComponent"],
                _calendar_form_dialog_calendar_form_dialog_component__WEBPACK_IMPORTED_MODULE_11__["CalendarFormDialogComponent"]
            ]
        })
    ], AppCalendarModule);
...
/***/ "./src/app/views/app-calendar/app-calendar.routing.ts":
/*!************************************************************!*\
  !*** ./src/app/views/app-calendar/app-calendar.routing.ts ***!
  \************************************************************/
...
/* harmony import */ var _app_calendar_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./app-calendar.component */ "./src/app/views/app-calendar/app-calendar.component.ts");

var CalendarRoutes = [
    { path: '', component: _app_calendar_component__WEBPACK_IMPORTED_MODULE_0__["AppCalendarComponent"], data: { title: 'Calendar' } }
];


/***/ }),

/***/ "./src/app/views/app-calendar/app-calendar.service.ts":
/*!************************************************************!*\
  !*** ./src/app/views/app-calendar/app-calendar.service.ts ***!
  \************************************************************/
/*! exports provided: AppCalendarService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AppCalendarService", function() { return AppCalendarService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _shared_inmemory_db_calendarEvents__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../shared/inmemory-db/calendarEvents */ "./src/app/shared/inmemory-db/calendarEvents.ts");
...
var AppCalendarService = /** @class */ (function () {
    function AppCalendarService(http) {
        this.http = http;
    }
    AppCalendarService.prototype.getEvents = function () {
        ...
        // });
        var _this = this;
        var eventDB = new _shared_inmemory_db_calendarEvents__WEBPACK_IMPORTED_MODULE_2__["CalendarEventDB"]();
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(eventDB.events)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (events) {
            _this.events = events;
            return events;
        }));
    };
    AppCalendarService.prototype.addEvent = function (event) {
        ...
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(this.events);
    };
    AppCalendarService.prototype.updateEvent = function (event) {
    ...
    AppCalendarService.prototype.deleteEvent = function (eventID) {
...
/***/ "./src/app/views/app-calendar/calendar-form-dialog/calendar-form-dialog.component.html":
/*!*********************************************************************************************!*\
  !*** ./src/app/views/app-calendar/calendar-form-dialog/calendar-form-dialog.component.html ***!
  \*********************************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/views/app-calendar/calendar-form-dialog/calendar-form-dialog.component.ts":
/*!*******************************************************************************************!*\
  !*** ./src/app/views/app-calendar/calendar-form-dialog/calendar-form-dialog.component.ts ***!
  \*******************************************************************************************/
...
/* harmony import */ var _shared_models_event_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../shared/models/event.model */ "./src/app/shared/models/event.model.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CalendarFormDialogComponent = /** @class */ (function () {
    function CalendarFormDialogComponent(dialogRef, data, formBuilder) {
        ...
        if (this.action === 'edit') {
            ...
            this.event = new _shared_models_event_model__WEBPACK_IMPORTED_MODULE_3__["EgretCalendarEvent"]({
                start: data.date,
                end: data.date
            });
        }
    ...
    CalendarFormDialogComponent.prototype.buildEventForm = function (event) {
        return new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            ...
            title: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](event.title),
            start: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](event.start),
            end: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](event.end),
    ...
    CalendarFormDialogComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./calendar-form-dialog.component.html */ "./src/app/views/app-calendar/calendar-form-dialog/calendar-form-dialog.component.html"),
            styles: [__webpack_require__(/*! ./calendar-form-dialog.component.scss */ "./src/app/views/app-calendar/calendar-form-dialog/calendar-form-dialog.component.scss")]
        }),
...
//# sourceMappingURL=views-app-calendar-app-calendar-module.js.map